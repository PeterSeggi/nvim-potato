...
local cap_status, cap = pcall(require, "cmp_nvim_lsp")
if not cap_status then
    print("Something went wrong requiring cmp_nvim_lsp")
    return
end

M.capabilities = cap.default_capabilities()
